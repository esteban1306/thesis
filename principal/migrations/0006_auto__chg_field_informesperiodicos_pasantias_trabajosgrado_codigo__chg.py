...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Informesperiodicos.pasantias_trabajosgrado_codigo' to match new field type.
        db.rename_column(u'informesperiodicos', u'pasantias_trabajosgrado_codigo', u'trabajosgrado_codigo')
        # Changing field 'Informesperiodicos.pasantias_trabajosgrado_codigo'
        db.alter_column(u'informesperiodicos', u'trabajosgrado_codigo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Pasantias'], db_column=u'trabajosgrado_codigo'))

        # Changing field 'Informesperiodicos.id'
        db.alter_column(u'informesperiodicos', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Modalidadespasantia.id'
        db.alter_column(u'modalidadespasantia', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
        # Deleting field 'Pasantias.codigo'
        db.delete_column(u'pasantias', 'codigo')


        # Changing field 'Pasantias.trabajosgrado_codigo'
        db.alter_column(u'pasantias', u'trabajosgrado_codigo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Trabajosgrado'], primary_key=True, db_column=u'trabajosgrado_codigo'))

    def backwards(self, orm):

        # Renaming column for 'Informesperiodicos.pasantias_trabajosgrado_codigo' to match new field type.
        db.rename_column(u'informesperiodicos', u'trabajosgrado_codigo', u'pasantias_trabajosgrado_codigo')
        # Changing field 'Informesperiodicos.pasantias_trabajosgrado_codigo'
        db.alter_column(u'informesperiodicos', u'pasantias_trabajosgrado_codigo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Pasantias'], db_column=u'pasantias_trabajosgrado_codigo'))

        # Changing field 'Informesperiodicos.id'
        db.alter_column(u'informesperiodicos', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Modalidadespasantia.id'
        db.alter_column(u'modalidadespasantia', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
        # Adding field 'Pasantias.codigo'
        db.add_column(u'pasantias', 'codigo',
                      self.gf('django.db.models.fields.BigIntegerField')(default=876, primary_key=True),
                      keep_default=False)


        # Changing field 'Pasantias.trabajosgrado_codigo'
        db.alter_column(u'pasantias', u'trabajosgrado_codigo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Trabajosgrado'], unique=True, db_column=u'trabajosgrado_codigo'))
    ...
    models = {
        ...
        u'principal.informesperiodicos': {
            ...
            'pasantias_trabajosgrado_codigo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Pasantias']", 'db_column': "u'trabajosgrado_codigo'"})
        },
        u'principal.jurados': {
        ...
        u'principal.pasantias': {
            ...
            'trabajosgrado_codigo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Trabajosgrado']", 'primary_key': 'True', 'db_column': "u'trabajosgrado_codigo'"})
        },
