...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pasantias.propuestaspasantias_id'
        db.delete_column(u'pasantias', 'propuestaspasantias_id')


    def backwards(self, orm):
        # Adding field 'Pasantias.propuestaspasantias_id'
        db.add_column(u'pasantias', 'propuestaspasantias_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=964, unique=True),
                      keep_default=False)
